...
"""esta función inicia el juego del blackjack al ulsar la tecla e"""
def iniciar_juego():
    while True:
...
"""esta función sirve para escoger una carta aleatoria entre las de la lista de las cartas"""
def obtener_carta():
    return random.choice(lista_de_cartas)

"""Esta función sirve para calcular la puntuación de la mano que tengas, sumando las cartas que tengas."""
...
"""Esta función te pregunta si quieres una tercera carta para poder superar al crupier"""
